...
var C = class extends e {
	...
	initDrag() {
		...
		this.dragStream = function(t, e = {}) {
			...
			const c = (e) => {
				...
				const l = e.pointerId;
				let c = e.clientX, d = e.clientY, u = !1;
				const p = Date.now(), { left: g, top: f } = t.getBoundingClientRect(), v = (t) => {
					...
					const e = t.clientX, n = t.clientY, h = e - c, m = n - d;
					(u || Math.abs(h) > i || Math.abs(m) > i) && (t.preventDefault(), t.stopPropagation(), u || (r.set({
						type: "start",
						x: c - g,
						y: d - f
					}), u = !0), r.set({
	...
	renderBarWaveform(t, e, i, n) {
		const { width: s, height: r } = i.canvas, { halfHeight: o, barWidth: a, barRadius: l, barIndexScale: h, barSpacing: c, barMinHeight: d } = function({ width: t, height: e, length: i, options: n, pixelRatio: s }) {
			...
			const h = t[0] || [], c = t[1] || h, d = h.length, m = [];
			let g = 0, f = 0, v = 0;
			for (let t = 0; t <= d; t++) {
				const d = Math.round(t * e);
				if (d > g) {
		...
		const { width: s, height: r } = i.canvas, o = function({ channelData: t, width: e, height: i, vScale: n }) {
			...
			return [r, t[1] || r].map(((t, i) => {
				...
				for (let e = 0; e <= r; e++) {
					...
					if (i > c) {
						const t = a + (Math.round(d * s * n) || 1) * l;
						h.push({
							x: c,
							y: t
						}), c = i, d = 0;
...
var w = class w extends d {
	...
	constructor(t) {
		...
		}), this.plugins = [], this.decodedData = null, this.stopAtPosition = null, this.subscriptions = [], this.mediaSubscriptions = [], this.abortController = null, this._isDestroyed = !1, this._loadVersion = 0, this.options = Object.assign({}, P, t);
		const { state: i, actions: n } = function(t) {
			var e, i, n, s, r, o;
			const a = null !== (e = null == t ? void 0 : t.currentTime) && void 0 !== e ? e : l(0), c = null !== (i = null == t ? void 0 : t.duration) && void 0 !== i ? i : l(0), d = null !== (n = null == t ? void 0 : t.isPlaying) && void 0 !== n ? n : l(!1), u = null !== (s = null == t ? void 0 : t.isSeeking) && void 0 !== s ? s : l(!1), p = null !== (r = null == t ? void 0 : t.volume) && void 0 !== r ? r : l(1), m = null !== (o = null == t ? void 0 : t.playbackRate) && void 0 !== o ? o : l(1), g = l(null), f = l(null), v = l(""), b = l(0), y = l(0), C = h((() => !d.value), [d]), S = h((() => null !== g.value), [g]);
			return {
				state: {
					currentTime: a,
					duration: c,
		...
		this.renderer = new C(this.options, s), this.initPlayerEvents(), this.initRendererEvents(), this.initTimerEvents(), this.initPlugins();
	...
	destroy() {
		var t;
		this._isDestroyed = !0, this.emit("destroy"), null === (t = this.abortController) || void 0 === t || t.abort(), this.plugins.forEach(((t) => t.destroy())), this.subscriptions.forEach(((t) => t())), this.unsubscribePlayerEvents(), this.timer.destroy(), this.renderer.destroy(), super.destroy();
	}
};
