...
// 4 lý do từ chối phổ biến toàn hệ thống - dùng đúng CATEGORIES ở trên
const REJECT_STATS = [
  { label: CATEGORIES[0].key, percentage: 45, count: '9 lần', color: CATEGORIES[0].color },
  { label: CATEGORIES[1].key, percentage: 28, count: '6 lần', color: CATEGORIES[1].color },
  { label: CATEGORIES[2].key, percentage: 17, count: '4 lần', color: CATEGORIES[2].color },
  { label: CATEGORIES[3].key, percentage: 10, count: '2 lần', color: CATEGORIES[3].color },
];
